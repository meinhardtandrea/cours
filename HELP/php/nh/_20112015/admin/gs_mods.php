...
function aff_files($rub_id,$srub_id) {
include ("conf.ig.php");
...
$sqlt = "SELECT * FROM " .$table_srub. " WHERE srub_id = '$srub_id' "; 
$reqt = mysql_query($sqlt) or die('Erreur SQL !'.$sqlt.'<br>'.mysql_error());
$rowt = mysql_fetch_array($reqt);
$srub_titre = $rowt['srub_titre'];

echo '<h1><a href="gs_index.php">Liste des rubriques</a> > <a href="gs_srub.php?rub_id='.$rub_id.'">'.$rub_titre.'</a> > '.$srub_titre.'</h1>'."\n";

echo '<div id="mmenu_fond">'."\n";
echo '<div id="mmenu">'."\n";
echo '<ul>'."\n";
echo '<li><a href="gs_srub.php?rub_id='.$rub_id.'">< Retour</a></li>'."\n";
echo '<li><a href="gs_mods.php?action=add_f&rub_id='.$rub_id.'&srub_id='.$srub_id.'">+ Ajouter un élément</a></li>'."\n";
echo '</ul>'."\n";
echo '</div>'."\n";
echo '</div>'."\n";
...
$sql = "SELECT * FROM " .$table_modules. " WHERE mod_srub_id = '$srub_id' ORDER BY mod_position ";
...
$sql_i = "SELECT * FROM " .$table_pdf. " WHERE pdf_srub_id = '$srub_id' ORDER BY pdf_position "; 
...
echo '<p align="right">[ <a href="gs_mods.php?action=add_news2&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'">Ajouter une actualité</a> ]</p>'."\n";
...
$trans_active = '<a href="gs_mods.php?action=act_on_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'"><img src="images/icones/off.gif" title="Activer l\'actualité" alt="Activer l\'actualité" align="absmiddle"></a>';
} else {
$trans_active = '<a href="gs_mods.php?action=act_off_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'"><img src="images/icones/on.gif" title="Désactiver l\'actualité" alt="Désactiver l\'actualité" align="absmiddle"></a>';
}

echo '<p align="right">[ <a href="gs_mods.php?action=edit_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'">Editer</a> ] [ <a href="gs_mods.php?action=del_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'&confirm=av">Supprimer</a> ] '.$trans_active.'</p>'."\n";
...
$trans_active = '<a href="gs_mods.php?action=act_on&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'"><img src="images/icones/off.gif" title="Activer l\'élément" alt="Activer l\'élément" align="absmiddle"></a>';
} else {
$trans_active = '<a href="gs_mods.php?action=act_off&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'"><img src="images/icones/on.gif" title="Désactiver l\'élément" alt="Désactiver l\'élément" align="absmiddle"></a>';
}

echo '<p align="right">[ <a href="gs_mods.php?action='.$lk_action.'&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'">Editer</a> ] [ <a href="gs_mods.php?action=del&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&confirm=av">Supprimer</a> ] '.$trans_active.'</p>'."\n";
...
function Add_f($rub_id,$srub_id) {
include ("conf.ig.php");

echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=rec_f&rub_id='.$rub_id.'&srub_id='.$srub_id.'" method="post">'."\n";
...
function Add_txt($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_txt_rec&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
...
echo '<p>[ <a href="gs_mods.php?action=del_mod_img&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'">Supprimer l\'image</a> ]</p>'."\n";
} else {
...
function Add_image($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_image_rec&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";
...
echo '<h5>Image</h5>'."\n";
if($mod_img){
echo '<p><img src="../files/images/'.$mod_img.'" width="640"></p>'."\n";
echo '<p>[ <a href="gs_mods.php?action=del_file_image&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'">Supprimer l\'image</a> ]</p>'."\n";
} else {
echo '<p><input class="text" type="file" name="img" /></p>'."\n";
}
...
function Add_gal($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_gal_rec1&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" >'."\n";
...
echo '<h1>Images<a name="fiches"></a></h1>'."\n";

echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_gal_rec2&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";

echo '<h5>Légende</h5>'."\n";
echo '<p><input type="text" class="text" name="img_titre" maxlength="80" size="40" value=""></p>'."\n";
...
echo '</div>'."\n";
///////////////////////////////////////////////////////////////
$sql = "SELECT * FROM " .$table_galeries. " WHERE img_mod_id = '$mod_id' ORDER BY img_position "; 
...
while($row = mysql_fetch_array($req)) {
$img_id = $row['img_id'];
$img_titre = $row['img_titre'];
$img_position = $row['img_position'];
$position = $img_position;
echo '<div id="list_img">'."\n";
echo '<table>'."\n";
echo '<tr>'."\n";
echo '<td colspan="2">'."\n";
echo '<img src="../files/galeries/mini_'.$row['img_name'].'" width="115" height="100" title="'.$img_titre.'" alt="'.$img_titre.'">'."\n";
echo '</td>'."\n";
echo '</tr>'."\n";
echo '<tr>'."\n";
...
echo '<td><a href="gs_mods.php?action=move_r&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&img_id='.$img_id.'&position='.$position.'"><img src="images/icones/b_right.png" alt="Mettre à droite" title="Mettre à droite"></a></td>'."\n";
} elseif ($position == $res) {
echo '<td><a href="gs_mods.php?action=move_l&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&img_id='.$img_id.'&position='.$position.'"><img src="images/icones/b_left.png" alt="Mettre à gauche" title="Mettre à gauche"></a></td>'."\n";
} else {
echo '<td><a href="gs_mods.php?action=move_l&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&img_id='.$img_id.'&position='.$position.'"><img src="images/icones/b_left.png" alt="Mettre à gauche" title="Mettre à gauche"></a> <a href="gs_mods.php?action=move_r&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&img_id='.$img_id.'&position='.$position.'"><img src="images/icones/b_right.png" alt="Mettre à droite" title="Mettre à droite"></a></td>'."\n";
}

echo '<td align="right"><a href="gs_mods.php?action=del_img&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&img_id='.$img_id.'"><img src="images/icones/cross.png" title="Supprimer l\'image" alt="Supprimer l\'image"></a></td>'."\n";
echo '</tr>'."\n";
echo '</table>'."\n";
echo '</div>'."\n";
}
echo '<div id="list_img_end">'."\n";
echo '</div>'."\n";
}
}
...
function Add_pdf($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_pdf_rec1&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" >'."\n";
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_pdf_rec2&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";
...
echo '<p><input class="text" type="file" name="fichier" /></p>'."\n";
...
echo '<td><a href="gs_mods.php?action=move_pdf_d&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&pdf_id='.$pdf_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_down.png" alt="Mettre dessous" title="Mettre dessous"></a></td>'."\n";
} elseif ($position == $res) {
echo '<td><a href="gs_mods.php?action=move_pdf_up&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&pdf_id='.$pdf_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_up.png" alt="Mettre dessus" title="Mettre dessus"></a></td>'."\n";
} else {
echo '<td><a href="gs_mods.php?action=move_pdf_up&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&pdf_id='.$pdf_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_up.png" alt="Mettre dessus" title="Mettre dessus"></a> <a href="gs_mods.php?action=move_pdf_d&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&pdf_id='.$pdf_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_down.png" alt="Mettre dessous" title="Mettre dessous"></a></td>'."\n";
}
...
echo '<td align="center"><a href="gs_mods.php?action=del_pdf&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&pdf_id='.$pdf_id.'"><img src="images/icones/cross.png" title="Supprimer l\'image" alt="Supprimer l\'image"></a></td>'."\n";
echo '</tr>'."\n";
}
echo '</table>'."\n";
}
...
function Add_news($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_news_rec1&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";
...
function Add_news2($rub_id,$srub_id,$mod_id) {
include ("conf.ig.php");

echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=add_news_rec2&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";
...
function Edit_news($rub_id,$srub_id,$mod_id,$news_id) {
include ("conf.ig.php");
...
echo '<div id="form">'."\n";
echo '<form action="gs_mods.php?action=edit_rec_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'" method="post" enctype="multipart/form-data">'."\n";
echo '<input type="hidden" name="MAX_FILE_SIZE" value="8000000">'."\n";
...
echo '<p>[ <a href="gs_mods.php?action=del_news_img&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'">Supprimer l\'image</a> ]</p>'."\n";
} else {
echo '<p><input class="text" type="file" name="img" /></p>'."\n";
}
...
if($res){
echo '<h1>Ordre des éléments :</h1>'."\n";

echo '<div id="mini_tab">'."\n";
echo '<table>'."\n";
...
if ($res == 1) {
echo '<td class="mini_position"></td>'."\n";
} elseif ($position == 1) {
echo '<td class="mini_position"><a href="gs_mods.php?action=moved&rub_id='.$rub_id.'&srub_id='.$srub_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_bottom.png" alt="Descendre" title="Descendre"></a></td>'."\n";
} elseif ($position == $res) {
echo '<td class="mini_position"><a href="gs_mods.php?action=moveup&rub_id='.$rub_id.'&srub_id='.$srub_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_top.png" alt="Monter" title="Monter"></a></td>'."\n";
} else {
echo '<td class="mini_position"><a href="gs_mods.php?action=moveup&rub_id='.$rub_id.'&srub_id='.$srub_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_top.png" alt="Monter" title="Monter"></a> <a href="gs_mods.php?action=moved&rub_id='.$rub_id.'&srub_id='.$srub_id.'&position='.$position.'"><img src="images/icones/bullet_arrow_bottom.png" alt="Descendre" title="Descendre"></a></td>'."\n";
}

echo '<td class="mini_titre"><b>'.$mod_titre.'</b><br/>('.$aff_type.')</td>'."\n";
...
$sqlt = "SELECT srub_titre FROM " .$table_srub. " WHERE srub_id = '$srub_id' "; 
$reqt = mysql_query($sqlt) or die('Erreur SQL !'.$sqlt.'<br>'.mysql_error());
$rowt = mysql_fetch_array($reqt);
$srub_titre = $rowt['srub_titre'];
...
echo '<div id="mmenu">'."\n";
echo '<ul>'."\n";
echo '<li><a href="gs_mods.php?rub_id='.$rub_id.'&srub_id='.$srub_id.'">< Retour</a></li>'."\n";
echo '</ul>'."\n";
echo '</div>'."\n";
echo '</div>'."\n";

Add_f($rub_id,$srub_id);
...
echo '<h1><a href="gs_index.php">Liste des rubriques</a> > <a href="gs_srub.php?rub_id='.$rub_id.'">'.$rub_titre.'</a> > <a href="gs_mods.php?rub_id='.$rub_id.'&srub_id='.$srub_id.'">'.$srub_titre.'</a></h1>'."\n";
...
$sql = "SELECT mod_id, mod_position FROM " .$table_modules. " WHERE mod_srub_id = '$srub_id' ";
$req = mysql_query($sql,$db) or die ('Erreur : '.mysql_error() );
$res = mysql_num_rows($req);

$position = ($res + 1);

$sql = "INSERT INTO " .$table_modules. "(mod_id, mod_rub_id, mod_srub_id, mod_titre, mod_type, mod_position, mod_activation) VALUES 
('','$rub_id','$srub_id','$mod_titre','$mod_type','$position','$mod_activation')";
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());

$mod_id = mysql_insert_id();

if($mod_type == 'text'){
Add_txt($rub_id,$srub_id,$mod_id);
} elseif($mod_type == 'pdf'){
Add_pdf($rub_id,$srub_id,$mod_id);
} elseif($mod_type == 'image'){
Add_image($rub_id,$srub_id,$mod_id);
} elseif($mod_type == 'news'){
Add_news($rub_id,$srub_id,$mod_id);
}
}
    break;
...
echo '<h1><a href="gs_index.php">Liste des rubriques</a> > <a href="gs_srub.php?rub_id='.$rub_id.'">'.$rub_titre.'</a> > <a href="gs_mods.php?rub_id='.$rub_id.'&srub_id='.$srub_id.'">'.$srub_titre.'</a> > '.$mod_titre.'</h1>'."\n";
...
echo '<p align="center"><a href="gs_mods.php?rub_id='.$rub_id.'&srub_id='.$srub_id.'"><img src="images/boutons/b_back.gif" alt="Retour" title="Retour"></a></p>'."\n";
...
Add_news2($rub_id,$srub_id,$mod_id);
...
Edit_news($rub_id,$srub_id,$mod_id,$news_id);
...
echo '<p align="center"><a href="gs_mods.php?action=del_news&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&news_id='.$news_id.'&confirm=oui"><img src="images/boutons/b_oui.jpg"></a> <a href="javascript:window.history.go(-1)"><img src="images/boutons/b_non.jpg"></a></p>';
break;
...
echo '<p align="center"><a href="gs_mods.php?rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'"><img src="images/boutons/b_back.gif" alt="Retour" title="Retour"></a></p>'."\n";
...
news_option1 = '$news_option1', news_option2 = '$news_option2' WHERE news_id = '$news_id'" or die ("erreur"); 
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());
...
$img_titre = AddSlashes($img_titre);

////////////////////////////////////////////////////////////////////////////////////////////////////////
if($_FILES['img']['name']) {
$dest_dossier = "../files/galeries/";
$img = $_FILES['img']['name'];
...
imagecopyresampled($destination, $source, 0, 0, 0, 0, $largeur_destination, $hauteur_destination, $largeur_source, $hauteur_source);
imagegif($destination, $dest_dossier.'mini_'.$img);
}
...
imagecopyresampled($destination, $source, 0, 0, 0, 0, $largeur_destination, $hauteur_destination, $largeur_source, $hauteur_source);
imagejpeg($destination, $dest_dossier.'mini_'.$img);
}
...
$sql = "INSERT INTO " .$table_galeries. "(img_id, img_rub_id, img_srub_id, img_mod_id, img_titre, img_name, img_position) VALUES 
('','$rub_id','$srub_id','$mod_id','$img_titre','$img','$position')";
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());
}
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$nom_fichier = time();
$fichier = $nom_fichier.'.'.$extension[1];
...
$sql = "INSERT INTO " .$table_pdf. "(pdf_id, pdf_rub_id, pdf_srub_id, pdf_mod_id, pdf_titre, pdf_name, pdf_position) VALUES 
('','$rub_id','$srub_id','$mod_id','$pdf_titre','$fichier','$position')";
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());
...
echo '<p align="center"><a href="gs_mods.php?action=del&rub_id='.$rub_id.'&srub_id='.$srub_id.'&mod_id='.$mod_id.'&confirm=oui"><img src="images/boutons/b_oui.jpg"></a> <a href="javascript:window.history.go(-1)"><img src="images/boutons/b_non.jpg"></a></p>';
break;

    case 'oui':


$sql_o = "SELECT * FROM " .$table_modules. " WHERE mod_srub_id = '$srub_id' ";
...
while($i != $res_o) {
$hop = $i - 1;
mysql_query("UPDATE " .$table_modules. " SET mod_position = '$hop' WHERE mod_position = '$i' AND mod_srub_id = '$srub_id' ") or die("</br>Erreur de suppression");
$i++;
}
$hop2 = $res_o - 1;
mysql_query("UPDATE " .$table_modules. " SET mod_position = '$hop2' WHERE mod_position = '$res_o' AND mod_srub_id = '$srub_id' ") or die("</br>Erreur de suppression");
mysql_query("DELETE FROM " .$table_modules. " WHERE mod_id = '$mod_id' ") or die("</br>Erreur de suppression");
}
...
$sql = "SELECT mod_position FROM " .$table_modules. " WHERE mod_srub_id = '$srub_id' ";
$req = mysql_query($sql,$db) or die ('Erreur : '.mysql_error() );
$res = mysql_num_rows($req);
...
$sql = "UPDATE " .$table_modules. " SET mod_position = '$position_tmp' WHERE mod_position = '$position' AND mod_srub_id = '$srub_id' " or die ("erreur"); 
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());	
$sql = "UPDATE " .$table_modules. " SET mod_position = '$position' WHERE mod_position = '$position_d' AND mod_srub_id = '$srub_id' " or die ("erreur"); 
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());    
$sql = "UPDATE " .$table_modules. " SET mod_position = '$position_d' WHERE mod_position = '$position_tmp' AND mod_srub_id = '$srub_id' " or die ("erreur"); 
mysql_query($sql) or die('Erreur SQL !'.$sql.'<br>'.mysql_error());
