...
$sqlb = "SELECT * FROM " .$table_modules. " WHERE mod_rub_id = '$res_rub_id' AND mod_activation = 'active' AND mod_rub_aff != 'right' ORDER BY mod_position "; 
...
$sqlb = "SELECT * FROM " .$table_modules. " WHERE mod_rub_id = '$res_rub_id' AND mod_activation = 'active' ORDER BY mod_position "; 
$reqb = mysql_query($sqlb) or die('Erreur SQL !'.$sqlb.'<br>'.mysql_error());
$resb = mysql_num_rows($reqb);
