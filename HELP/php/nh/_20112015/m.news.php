...
echo '<table>'."\n";
echo '<tr>'."\n";
echo '<td valign="top" width="80%">'.$news_texte.'</td>'."\n";
echo '<td align="right" valign="top" width="20%"><img src="files/news/'.$news_img.'" width="300"></td>'."\n";
echo '</tr>'."\n";
echo '</table>'."\n";
} else {
echo '<h1>'.$news_titre.'</h1>'."\n";
...
$prev = '<a href="m.news-'.$page.'-'.$news_id_r.'.html">'.$news_titre.' ></a>';
}
...
$next = '<a href="m.news-'.$page.'-'.$news_id_n.'.html">< '.$news_titre.'</a>';
}
