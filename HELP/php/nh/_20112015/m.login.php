...
echo '<form action="m.login-'.$page.'.html" method="post">'."\n";
...
echo '<form action="m.login-'.$page.'.html" method="post">'."\n";
echo '<h4><label for="pseudo">Votre courriel</label></h4>'."\n";
echo '<p><input type="text" name="user_mail" id="user_mail" maxlength="250" size="32" value=""></p>'."\n";
echo '<p><input type="submit" class="envoy" name="recup" value="Récupérer" /></p>'."\n";
echo '</form>'."\n";
