...
if (empty($_POST['mail'])) { header('Location: ./index-'.$position.'-1.html'); }
elseif (empty($_POST['sujet'])) { header('Location: ./index-'.$position.'-2.html'); }
elseif (empty($_POST['code_postal'])) { header('Location: ./index-'.$position.'-6.html'); }
elseif (empty($_POST['msg'])) { header('Location: ./index-'.$position.'-3.html'); }
elseif (!ereg("([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z]+)", $exp)) { header('Location: ./index-'.$position.'-4.html'); }
...
if($envoi) { header('Location: ./index-'.$position.'-6.html'); }
else { header('Location: ./index-'.$position.'-7.html'); }


}

} else {
header('Location: ./index-'.$position.'-5.html');
}
}
?>